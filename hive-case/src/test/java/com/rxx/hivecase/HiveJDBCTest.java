package com.rxx.hivecase;

import com.rxx.hivecase.util.HiveJdbcCliUtil;
...
//        stmt = conn.createStatement();
    ...
    public void test(){
        ...
        String pat = "/\\w+;";
        String urlN  = url.replaceFirst(pat,String.format("/%s;", "default"));
        System.out.println("===O" + url);
        System.out.println("===N" + urlN);
    }
}
