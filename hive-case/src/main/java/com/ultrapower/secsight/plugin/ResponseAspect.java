...
import com.ultrapower.secsight.checkhive.entry.ResultData;
...
public class ResponseAspect {
    ...
    @Pointcut("execution(* com.ultrapower.secsight.checkhive.controller.*.*(..)) && @annotation(com.ultrapower.secsight.plugin.ResponseJson)")
